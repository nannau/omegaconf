...
@mark.parametrize(
    ...
    [
        ...
        # list key path where final node is a list
        param(
            {"x": {"y": [1, 2]}},
            ["x", "y"],
            [3, 4],
        ...
        param(
            ...
            False,
            {"x": {"y": [3, 4]}},
            id="list_key:list_set",
        ),
        # list key path including an index
        param(
            {"x": {"y": [1, 2, 3]}},
            ["x", "y", 1],
            "abc",
            True,
            {"x": {"y": [1, "abc", 3]}},
            id="list_key:index:update:merge",
        ),
        param(
            {"x": {"y": [1, 2, 3]}},
            ["x", "y", 1],
            ...
            False,
            {"x": {"y": [1, "abc", 3]}},
            id="list_key:index:update:set",
        ),
        # tuple equivalent of the above
        param(
            {"x": {"y": [1, 2, 3]}},
            ("x", "y", 1),
            "abc",
            True,
            {"x": {"y": [1, "abc", 3]}},
            id="tuple_key:index:update:merge",
        ),
        param(
            {"x": {"y": [1, 2, 3]}},
            ("x", "y", 1),
        ...
        param(
            ...
            False,
            {"x": {"y": [1, 2, 3]}, "a:b": {"c": 20}},
            id="list_key:index:update:set_with_colon",
        ),
        param(
            {"x": {"y": [1, 2, 3]}, "a:b": {"c": 10}},
            ("a:b", "c"),
            ...
            False,
            {"x": {"y": [1, 2, 3]}, "a:b": {"c": 20}},
            id="tuple_key:index:update:set_with_colon",
        ),
        param(
            {"x": {"y": [1, 2, 3]}, "a[b]": {"c": 10}},
            ("a[b]", "c"),
            ...
            False,
            {"x": {"y": [1, 2, 3]}, "a[b]": {"c": 20}},
            id="tuple_key:index:update:set_with_bracket",
        ),
        param(
            {"x": {"y": [1, 2, 3]}, "a[b]": {"c": 10}},
            ["a[b]", "c"],
